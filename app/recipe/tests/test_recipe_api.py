...
def sample_ingrediant(user, name='Cinnamon'):
    """Create and return sample ingrediant"""
...
class PuclicRecipeApiTests(TestCase):
...
class PrivateRecipeApiTest(TestCase):
    ...
    def test_retrieve_authenticate(self):
...
class RecipeImageUploadTests(TestCase):
    ...
    def test_filter_recipe_by_ingrediants(self):
        """Test returning recipe with specific ingrediants"""
        recipe1 = sample_recipe(user=self.user, title='Posh bean on toast')
        recipe2 = sample_recipe(user=self.user, title='Chicken cacciatore')
        ingrediant1 = sample_ingrediant(user=self.user, name='Feta cheese')
        ingrediant2 = sample_ingrediant(user=self.user, name='Chicken')
